...
public class PlacePickerActivity extends Activity
    ...
    private RecyclerView plePicker;
    private LinearLayoutManager plePickerManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        plePicker = (RecyclerView)findViewById(R.id.placesList);
        plePicker.setHasFixedSize(true);
        plePickerManager = new LinearLayoutManager(this);
        plePicker.setLayoutManager(plePickerManager);
        plePicker.addItemDecoration(new DividerItemDecoration(plePicker.getContext(), plePickerManager.getOrientation()));
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            Location mLastLocation = LocationServices.FusedLocationApi.getLastLocation(gGoogleApiClient);
            ...
            if (mLastLocation != null) {
                ...
                coffeeCall.enqueue(new Callback<FoursquareJSON>() {
                    ...
                    public void onResponse(Call<FoursquareJSON> call, Response<FoursquareJSON> response) {
                        ...
                        plePicker.setAdapter(placePickerAdapter);
                    }
                    @Override
                    public void onFailure(Call<FoursquareJSON> call, Throwable t) {
                        Toast.makeText(getApplicationContext(), "Application can't connect to Foursquare's servers!", Toast.LENGTH_LONG).show();
